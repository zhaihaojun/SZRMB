...
struct MyApp {
    ...
    balance: Arc<Mutex<f32>>,  // Use Arc<Mutex<f32>> for thread safety
    is_running: bool,
    status: Vec<String>,
    own_ip: String,
    own_port: String,
    received_message: Arc<Mutex<String>>,  // Use Arc<Mutex<String>> for thread safety
}
...
impl eframe::App for MyApp {
    fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
        egui::CentralPanel::default().show(ctx, |ui| {
            ui.label("Threshold Wallet: User C");
            ui.add_space(20.0);
            ...
            ui.horizontal(|ui| {
                ...
                if ui.add_sized(egui::vec2(80.0, 18.0), egui::Button::new("Start Listen")).clicked() {
                    ...
                    self.own_ip = self.your_ip.clone();  // Add this line
                    self.own_port = self.your_port.clone();  // Add this line   
...
fn main() {
    let app = MyApp {
        ...
        own_ip: String::new(),
        own_port: String::new(),
        received_message: Arc::new(Mutex::new(String::new())),  // Initialize with Arc<Mutex<String>>
    };
